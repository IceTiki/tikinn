...
if __name__ == "__main__":
    ...
    paths = constants.Directions

    # source
    transvert_dataset(
        paths.office_art,
        paths.dataset / "art_train_e5_a",
        transvert_method=trivial_augment_wide,
        expand=7,
        sample_range=[0, 1],
    )
    ...
    transvert_dataset(
        paths.office_clipart,
        paths.dataset / "clipart_train_e5_a",
        transvert_method=trivial_augment_wide,
        expand=7,
        sample_range=[0, 1],
    )
    ...
    transvert_dataset(
        paths.office_product,
        paths.dataset / "product_train_e5_a",
        transvert_method=trivial_augment_wide,
        expand=7,
        sample_range=[0, 1],
    )
    ...
    transvert_dataset(
        paths.office_realworld,
        paths.dataset / "realworld_train_e5_a",
        transvert_method=trivial_augment_wide,
        expand=7,
        sample_range=[0, 1],
    )
    ...
    transvert_dataset(
        paths.office_art,
        paths.dataset / "art_train_e5_r",
        transvert_method=raw_img,
        expand=7,
        sample_range=[0, 1],
    )
    ...
    transvert_dataset(
        paths.office_clipart,
        paths.dataset / "clipart_train_e5_r",
        transvert_method=raw_img,
        expand=7,
        sample_range=[0, 1],
    )
    ...
    transvert_dataset(
        paths.office_product,
        paths.dataset / "product_train_e5_r",
        transvert_method=raw_img,
        expand=7,
        sample_range=[0, 1],
    )
    ...
    transvert_dataset(
        paths.office_realworld,
        paths.dataset / "realworld_train_e5_r",
        transvert_method=raw_img,
        expand=7,
        sample_range=[0, 1],
    )
